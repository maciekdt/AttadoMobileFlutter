...
class ContactsCustomFilteringForm extends StatefulWidget {
  const ContactsCustomFilteringForm({super.key});

  @override
  State<StatefulWidget> createState() => _ContactsCustomFilteringFormState();
}

class _ContactsCustomFilteringFormState
    extends State<ContactsCustomFilteringForm> {
  late ContactsOptionsProvider _optionsProvider;

  void _selectMyFilter() async {
    var result = await context.push("/contacts/filter/my-filter");
    if (result != null) {
  ...
  void _selectSystemFilter() async {
    var result = await context.push("/contacts/filter/system-filter");
    if (result != null) {
